...
replaceitem entity @e[type=stray,r=3,c=1] slot.armor.chest 0 leather_chestplate 1
replaceitem entity @e[type=stray,r=3,c=1] slot.armor.legs 0 leather_leggings 1
replaceitem entity @e[type=stray,r=3,c=1] slot.armor.feet 0 leather_boots 1
