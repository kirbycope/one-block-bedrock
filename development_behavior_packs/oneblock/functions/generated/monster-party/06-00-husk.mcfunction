...
replaceitem entity @e[type=husk,r=3,c=1] slot.armor.head 0 iron_helmet 1
replaceitem entity @e[type=husk,r=3,c=1] slot.armor.chest 0 leather_chestplate 1
replaceitem entity @e[type=husk,r=3,c=1] slot.armor.legs 0 iron_leggings 1
replaceitem entity @e[type=husk,r=3,c=1] slot.armor.feet 0 leather_boots 1
tag @e[type=husk,r=3,c=1] add ija-a4-monster-party-mob
