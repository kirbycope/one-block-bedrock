...
summon piglin ~ ~1.6 ~
replaceitem entity @e[type=piglin,r=3,c=1] slot.weapon.mainhand 0 golden_spear 1
...
execute if entity @s[scores={ija-a4-random-mob-amount=2..}] run replaceitem entity @e[type=piglin,r=3,c=1] slot.weapon.mainhand 0 golden_spear 1
