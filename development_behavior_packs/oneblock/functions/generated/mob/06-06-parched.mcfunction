...
summon husk ~ ~1.6 ~
replaceitem entity @e[type=husk,r=3,c=1] slot.weapon.mainhand 0 bow 1
...
execute if entity @s[scores={ija-a4-random-mob-amount=3..}] run replaceitem entity @e[type=husk,r=3,c=1] slot.weapon.mainhand 0 bow 1
