...
execute if entity @s[scores={ija-a4-afterphases-randomizer=396}] run loot insert ~ ~ ~ loot "loot_tables/ija-one-block/builder-all.json"
...
execute if entity @s[scores={ija-a4-afterphases-randomizer=397}] run loot insert ~ ~ ~ loot "loot_tables/ija-one-block/musical.json"
...
execute if entity @s[scores={ija-a4-afterphases-randomizer=398}] run loot insert ~ ~ ~ loot "loot_tables/ija-one-block/odd.json"
...
execute if entity @s[scores={ija-a4-afterphases-randomizer=399}] run loot insert ~ ~ ~ loot "loot_tables/ija-one-block/rare.json"
...
execute if entity @s[scores={ija-a4-afterphases-randomizer=400}] run loot insert ~ ~ ~ loot "loot_tables/ija-one-block/10-variety.json"
