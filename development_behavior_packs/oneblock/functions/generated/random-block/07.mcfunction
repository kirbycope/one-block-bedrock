...
execute if entity @s[scores={ija-a4-random-block-type=2359..2403}] run setblock ~ ~ ~ brown_hardened_clay
execute if entity @s[scores={ija-a4-random-block-type=2404..2448}] run setblock ~ ~ ~ yellow_hardened_clay
execute if entity @s[scores={ija-a4-random-block-type=2449..2493}] run setblock ~ ~ ~ orange_hardened_clay
execute if entity @s[scores={ija-a4-random-block-type=2494..2538}] run setblock ~ ~ ~ red_hardened_clay
