...
execute if entity @s[scores={ija-a4-random-mob-type=5..6}] run function generated/mob/06-02-turtle
...
execute if entity @s[scores={ija-a4-random-mob-type=14..15}] run function generated/mob/06-06-husk
