execute as @p[scores={timer=0}] run scoreboard players set @s timer 1

execute as @s[scores={timer=1}] run title @s title §cUpgrade in

execute as @s[scores={timer=20}] run title @s subtitle §610
execute as @s[scores={timer=20}] run title @s title §cUpgrade in

execute as @s[scores={timer=40}] run title @s subtitle §69
execute as @s[scores={timer=40}] run title @s title §cUpgrade in

execute as @s[scores={timer=60}] run title @s subtitle §68
execute as @s[scores={timer=60}] run title @s title §cUpgrade in

execute as @s[scores={timer=80}] run title @s subtitle §67
execute as @s[scores={timer=80}] run title @s title §cUpgrade in
