...
execute as @s[scores={random=34}] run setblock 0 63 0 red_terracotta
execute as @s[scores={random=35}] run setblock 0 63 0 orange_terracotta
execute as @s[scores={random=36}] run setblock 0 63 0 yellow_terracotta
execute as @s[scores={random=37}] run setblock 0 63 0 brown_terracotta
...
execute as @s[scores={random=49}] run setblock 0 63 0 light_gray_terracotta
execute as @s[scores={random=50}] run setblock 0 63 0 white_terracotta
