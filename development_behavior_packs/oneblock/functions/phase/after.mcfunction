...
execute as @s[scores={random=396}] run setblock 0 63 0 chest11o
execute as @s[scores={random=397}] run setblock 0 63 0 chest11o
execute as @s[scores={random=398}] run setblock 0 63 0 chest110
execute as @s[scores={random=399}] run setblock 0 63 0 chest11m
execute as @s[scores={random=400}] run setblock 0 63 0 chest11r
# Spawn mob
