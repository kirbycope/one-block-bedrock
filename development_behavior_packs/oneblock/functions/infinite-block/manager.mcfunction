...
execute if entity @s[tag=ija-a4-mined] at @s run function infinite-block/increase-counter
...
execute if entity @s[scores={ija-a4-persistent-barrier-counter=20..}] run setblock ~ ~ ~ dirt
...
execute if entity @s[tag=ija-a4-party] run function generated/monster-party/manager
execute as @e[scores={ija-a4-party-monster-time-left=1..}] at @s run function monster-party/guard-manager
